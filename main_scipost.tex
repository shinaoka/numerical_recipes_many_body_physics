...
The Green's function $G(\tau)$ is known only on the mesh points.
...
The RHS of Eq.~\eqref{eq:naive-fourier-transform} converges to the exact value in the limit of $N_\tau \rightarrow \infty$.
