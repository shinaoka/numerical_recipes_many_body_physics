...
\begin{python}
smpl = sparse-ir.TauSampling(basis)
...
smpl = sparse-ir.TauSampling(basis, sampling_points=my_smpl_points)
\end{python}
\end{Exercise}
...
\begin{python}
smpl_matsu = sparse-ir.MatsubaraSampling(basis)
...
\begin{Exercise}
    ...
    my_smpl_points = ***
    smpl_matsu = sparse-ir.MatsubaraSampling(basis, sampling_points=my_smpl_points)
    \end{python}
\end{Exercise}
