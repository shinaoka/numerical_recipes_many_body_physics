...
basis.s # Singular values
basis.u # IR basis functions for tau
basis.v # IR basis functions for omega
\end{python}
...
An instance object of \texttt{FiniteTempBasis} has many data attributes and functions.
