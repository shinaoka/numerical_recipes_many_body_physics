...
$\mu~(=U/2)$. The non-interacting band dispersion is given by
\begin{align}
    \epsilon(\bk,\sigma) &= -2 (\cos{k_x} + \cos{k_y}),
\end{align}
where $\bk=(k_x, k_y)$.
...
\begin{align}
    \Sigma(\tau, \br) &= U^2 G^2(\tau, \br) G(\beta-\tau, \br),
\end{align}
